...
<form id="add-form" class="form-horizontal" role="form" action="/erp/hrm/employee/edit" method="post">
	...
	<div class="form-group">
		...
		<div class="col-sm-3">
			...
			<input required name="expiredDate" class="form-control"	id="from-datepicker" value="">
		</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-2">
			<label for="lastname" class="col-sm-12 control-label text-left">Zip	code</label> 
			<input required name="expiredDate" class="form-control"	id="from-datepicker" value="">
		</div>
	...
	<div class="form-group">
		<label for="firstname" class="col-sm-3 control-label">Position Type :</label>
		<div class="col-sm-7">
			<input required name="title" type="text" class="form-control" value="">
		</div>
	...
	<div class="form-group">
		<label for="firstname" class="col-sm-3 control-label">Hired Date :</label>
		<div class="col-sm-3">
			<input required name="title" type="text" class="form-control" id="hired-date">
		</div>
	</div>
	...
	<div class="form-group">
		<label for="firstname" class="col-sm-3 control-label"><br>Contact Information :</label>
		<div class="col-sm-3">
			<label for="firstname" class="col-sm-12 control-label">Email Address </label> 
			<input required name="title" type="text" class="form-control" value="">
		</div>
		
		<div class="col-sm-2">
			<label for="firstname" class="col-sm-12 control-label">Mobile</label> 
			<input required name="title" type="text" class="form-control" value="">
		</div>
		
		<div class="col-sm-2" style="padding-right: 0">
			<label for="firstname" class="col-sm-12 control-label">Home	Number</label> 
			<input required name="title" type="text" class="form-control" value="">
		</div>
	</div>
	...
	<div class="form-group">
		<label for="firstname" class="col-sm-3 control-label">POC Phone Number :</label>
		<div class="col-sm-6">
			<input required name="title" type="text" class="form-control">
		</div>
	</div>
	...
	<div class="form-group">
		<label for="firstname" class="col-sm-3 control-label">Evaluation Date:</label>
		<div class="col-sm-3">
	...
	<div class="form-group">
		<label for="firstname" class="col-sm-3 control-label">Tax Infomation:</label>
		<div class="col-sm-6">
			<input required name="title" id="evaluation-date" type="text"
				class="form-control">
		</div>
	...
	<div class="form-group">
		<label for="firstname" class="col-sm-3 control-label"><br>Wage Garnishment:</label>
		<div class="col-sm-6">
	...
	<div class="form-group">
		<label for="firstname" class="col-sm-3 control-label"> </label>
		<div class="col-sm-3">
			<input required name="title" type="checkbox"> Rehire 
			<input required name="title" type="checkbox"> Not Rehired
		</div>
	</div>
	
	<div class="form-group">
		<label for="lastname" class="col-sm-3 control-label">Reason for Termination:</label>
		<div class="col-sm-6">
			<select class="form-control">
	...
	<div class="form-group">
		<div class="col-sm-offset-3 col-sm-1">
			<a href='/erp/hrm/recruitment/candidate_tracker_list' type="submit"	class="btn btn-danger">Update</a>
		</div>
	</div>
</form>
