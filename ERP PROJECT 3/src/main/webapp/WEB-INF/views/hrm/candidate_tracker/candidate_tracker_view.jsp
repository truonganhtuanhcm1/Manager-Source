...
<title>Candidate Tracker View</title>
...
<form id="add-form" class="form-horizontal" role="form" enctype="multipart/form-data"
	...
	<h3>Candidate Tracker View</h3>
	
	<div class="form-group">
		<label for="candidateTrackerIdInput" class="col-sm-3 control-label">Candidate ID :</label>
		<div class="col-sm-3">
			<input disabled required name="candidateTrackerIdInput" class="form-control" type="text" value="${target.candidate_tracker_id_input}">
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-3">
			<select disabled required class="form-control contractId" name="contractId">
	...
	<div class="form-group">
		<label for="lastname" class="col-sm-3 control-label">Requisition
			ID :</label>
		<div class="col-sm-3">
			<select disabled required class="form-control requisitionId"
				name="requisitionId">
	...
	<div class="form-group">
		...
		<div class="col-sm-2">
			<label for="firstname" class="col-sm-12 control-label">First
				Name </label> <input disabled required name="firstName" type="text"
				class="form-control" value="${target.first_name}">
		</div>
		<div class="col-sm-2">
			<label for="firstname" class="col-sm-12 control-label">Last
				Name </label> <input disabled required name="lastName" type="text"
				class="form-control" value="${target.last_name}">
		</div>
		<div class="col-sm-2">
			<label for="firstname" class="col-sm-12 control-label">M.I </label> <input disabled
	...
	<div class="form-group">
		...
		<div class="col-sm-2">
			...
			<input disabled required name="city" class="form-control" type="text"
				value="${target.city}">
		</div>

		<div class="col-sm-2">
			<label for="lastname" class="col-sm-12 control-label text-left">State</label>
			<select disabled required class="form-control stateId" name="stateId">
		...
		<div class="col-sm-2">
			...
			<select disabled required class="form-control" name="countryId">
	...
	<div class="form-group">
		...
		<div class="col-sm-3">
			<select disabled name="statusId" id="statusId" class="form-control">
		...
		<div class="col-sm-3">
			<input disabled id="statusOther" name="statusOther" type="text" class="form-control" value="${target.status_other}">
		</div>
	</div>
	...
	<div class="form-group">
		<label for="firstname" class="col-sm-3 control-label">Job
			Location:</label>
		<div class="col-sm-6">
			<input disabled name="jobLocation" class="form-control" type="text"
	...
	<div class="form-group">
		<label for="lastname" class="col-sm-3 control-label">Candidate
			Salary Range:</label>
		<div class="col-sm-6">
			<input disabled required name="salaryRange" type="text" class="form-control"
	...
	<div class="form-group">
		...
		<div class="col-sm-3">
			<input disabled  required name="certifications" type="text"
	...
	<div class="form-group">
		...
		<div class="col-sm-6">
			...
			<textarea disabled required name="experience" rows="2" class="form-control" 
	...
	<div class="form-group">
		<label for="lastname" class="col-sm-3 control-label">Email
			Address:</label>
		<div class="col-sm-2">
			<select disabled id="emailType" class="form-control">
		...
		<div class="col-sm-3">
			<input disabled id="emailFirst"  name="emailFirst"  type="text" class="form-control" value="${target.email_first}">
			<input disabled id="emailSecond" name="emailSecond" type="text" class="form-control" value="${target.email_second}">
			<input disabled id="emailThird"  name="emailThird"  type="text" class="form-control" value="${target.email_third}">
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-2">
			<select disabled id="phoneType" class="form-control">
		...
		<div class="col-sm-3">
			<input disabled id="phoneFirst"  name="phoneFirst"  type="text" class="form-control" value="${target.phone_first}">
			<input disabled id="phoneSecond" name="phoneSecond" type="text" class="form-control" value="${target.phone_second}">
			<input disabled id="phoneThird"  name="phoneThird"  type="text" class="form-control" value="${target.phone_third}">
		</div>
	</div>
	...
	<div class="form-group">
		<label for="lastname" class="col-sm-3 control-label">Best Time
			to Contact:</label>
		<div class="col-sm-5">
			<input disabled required name="bestTimeContact" type="text"
	...
	<div class="form-group">
		<label for="lastname" class="col-sm-3 control-label">Email
			Date:</label>
		<div class="col-sm-2">
			<select disabled name="emailDateType" class="form-control">
		...
		<div class="col-sm-3">
			<input disabled required name="emailDate" class="form-control"
	...
	<div class="form-group">
		<label for="lastname" class="col-sm-3 control-label">Call
			Date:</label>
		<div class="col-sm-2">
			<select disabled name="callDateType" class="form-control">
		...
		<div class="col-sm-3">
			<input disabled required name="callDate" class="form-control"
	...
	<div class="form-group">
		...
		<div class="col-sm-6">
			<input disabled name="altPosition" class="form-control" type="text"
	...
	<div class="form-group">
		<label for="lastname" class="col-sm-3 control-label">Candidate
			Comments:</label>
		<div class="col-sm-6">
			<textarea disabled required name="candidateComment" rows="4"
	...
	<div class="form-group">
		<label for="lastname" class="col-sm-3 control-label">DVS
			Comments:</label>
		<div class="col-sm-6">
			<textarea disabled required name="dvsComment" rows="4" class="form-control"
	...
	<div class="form-group">
		<label for="lastname" class="col-sm-3 control-label">Question
			1:</label>
		<div class="col-sm-6">
			<input disabled name="question1" class="form-control" type="text"
	...
	<div class="form-group">
		...
		<div class="col-sm-6">
			<textarea disabled required name="description1" rows="3" class="form-control"
	...
	<div class="form-group">
		<label for="lastname" class="col-sm-3 control-label">Question
			2:</label>
		<div class="col-sm-6">
			<input disabled name="question2" class="form-control" type="text"
	...
	<div class="form-group">
		<label for="lastname" class="col-sm-3 control-label"></label>
		<div class="col-sm-6">
			<textarea disabled required name="description2" rows="3" class="form-control"
	...
	<div class="form-group">
		<label for="lastname" class="col-sm-3 control-label">Question
			3:</label>
		<div class="col-sm-6">
			<input disabled name="question3" class="form-control" type="text"
	...
	<div class="form-group">
		<label for="lastname" class="col-sm-3 control-label"></label>
		<div class="col-sm-6">
			<textarea disabled required name="description3" rows="3" class="form-control"
	...
	<div class="form-group">
		<label for="lastname" class="col-sm-3 control-label">Question
			4:</label>
		<div class="col-sm-6">
			<input disabled name="question4" class="form-control" type="text"
	...
	<div class="form-group">
		<label for="lastname" class="col-sm-3 control-label"></label>
		<div class="col-sm-6">
			<textarea disabled required name="description4" rows="3" class="form-control"
	...
	<div class="form-group">
		<label for="lastname" class="col-sm-3 control-label">Question
			5:</label>
		<div class="col-sm-6">
			<input disabled name="question5" class="form-control" type="text"
	...
	<div class="form-group">
		<label for="lastname" class="col-sm-3 control-label"></label>
		<div class="col-sm-6">
			<textarea disabled required name="description5" rows="3" class="form-control"
	...
	<div style='display: none'>
		...
		<div class="form-group">
			<label for="firstname" class="col-sm-3 control-label">Refered
				Location:</label>
			<div class="col-sm-6">
				<input disabled name="referedLocation" class="form-control" type="text"
		...
		<div class="form-group">
			<label for="lastname" class="col-sm-3 control-label">Phone
				Screen Date:</label>
			<div class="col-sm-3">
				<input disabled name="phoneScreenDate" class="form-control"
		...
		<div class="form-group">
			<label for="lastname" class="col-sm-3 control-label"></label>
			<div class="col-sm-6">
				<textarea disabled name="qQualification" rows="4" class="form-control"
		...
		<div class="form-group">
			<label for="lastname" class="col-sm-3 control-label"></label>
			<div class="col-sm-6">
				<textarea disabled name="qBackground" rows="4" class="form-control"
		...
		<div class="form-group">
			<label for="lastname" class="col-sm-3 control-label"></label>
			<div class="col-sm-6">
				<textarea disabled name="qTechnicalSkill" rows="4" class="form-control"
		...
		<div class="form-group">
			<label for="lastname" class="col-sm-3 control-label"></label>
			<div class="col-sm-6">
				<input disabled name="qExpectedSalary" class="form-control" type="text"
		...
		<div class="form-group">
			<label for="lastname" class="col-sm-3 control-label"></label>
			<div class="col-sm-6">
				<textarea disabled name="qCommunication" rows="4" class="form-control"
		...
		<div class="form-group">
			<label for="lastname" class="col-sm-3 control-label"></label>
			<div class="col-sm-6">
				<textarea disabled name="qInitiative" rows="4" class="form-control"
		...
		<div class="form-group">
			<label for="lastname" class="col-sm-3 control-label">Avaliable
				Start Date:</label>
			<div class="col-sm-3">
				<input disabled name="availableStartDate" class="form-control"
	...
	<div class="form-group">
		...
		<div class="col-sm-4">
			<input disabled required disabled id="txtAttachment" class="form-control" value="${target.attachment}"/>
		</div>
		
		<div class="col-sm-3">
			<input disabled id="fileAttachment" type="file" class="form-control attachment" name="attachment" />
			
			<a href="/erp/file/view/${target.attachment}.file" target="_blank" class="btn btn-primary">View file</a>
		
			<a href="/erp/hrm/candidate_tracker/download/${target.attachment}.file" class="btn btn-primary">Download</a>
			<input disabled type="hidden" name="oldfile" value="${target.attachment}">
		</div>
	</div>
